...
NotifyIconWindow::NotifyIconWindow(HINSTANCE instance) :
	...
	m_window(0, m_windowClass.className().c_str(), APP_NAME, 0, 0, 0, 0, 0, HWND_MESSAGE, nullptr, m_instance, nullptr),
...
{
	NotifyIconWindow* window = reinterpret_cast<NotifyIconWindow*>(GetWindowLongPtrW(hWnd, GWLP_USERDATA));
	assert(window != nullptr && "NotifyIconWindow missing GWLP_USERDATA!");
